...
function findWasmBinary() {
  return locateFile('raytest.wasm');
}
...
var ASM_CONSTS = {
  2122450: () => { if (document.fullscreenElement) return 1; },  
 2122496: () => { return Module.canvas.width; },  
 2122528: () => { return parseInt(Module.canvas.style.width); },  
 2122576: () => { document.exitFullscreen(); },  
 2122603: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 2122675: () => { if (document.fullscreenElement) return 1; },  
 2122721: () => { return Module.canvas.width; },  
 2122753: () => { return screen.width; },  
 2122778: () => { document.exitFullscreen(); },  
 2122805: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 2122999: () => { return window.innerWidth; },  
 2123025: () => { return window.innerHeight; },  
 2123052: () => { if (document.fullscreenElement) return 1; },  
 2123098: () => { return Module.canvas.width; },  
 2123130: () => { return parseInt(Module.canvas.style.width); },  
 2123178: () => { if (document.fullscreenElement) return 1; },  
 2123224: () => { return Module.canvas.width; },  
 2123256: () => { return screen.width; },  
 2123281: () => { return window.innerWidth; },  
 2123307: () => { return window.innerHeight; },  
 2123334: () => { if (document.fullscreenElement) return 1; },  
 2123380: () => { return Module.canvas.width; },  
 2123412: () => { return screen.width; },  
 2123437: () => { document.exitFullscreen(); },  
 2123464: () => { if (document.fullscreenElement) return 1; },  
 2123510: () => { return Module.canvas.width; },  
 2123542: () => { return parseInt(Module.canvas.style.width); },  
 2123590: () => { document.exitFullscreen(); },  
 2123617: ($0) => { Module.canvas.style.opacity = $0; },  
 2123655: () => { return screen.width; },  
 2123680: () => { return screen.height; },  
 2123706: () => { return window.screenX; },  
 2123733: () => { return window.screenY; },  
 2123760: () => { return window.devicePixelRatio; },  
 2123796: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 2123849: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2123900: () => { Module.canvas.style.cursor = 'none'; },  
 2123937: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 2124193: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2124244: () => { if (document.pointerLockElement) return 1; },  
 2124291: () => { if (document.fullscreenElement) return 1; },  
 2124337: () => { return window.innerWidth; },  
 2124363: () => { return window.innerHeight; }
};
